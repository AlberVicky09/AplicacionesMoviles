...
public class MainActivity extends AppCompatActivity {
    ...
    //Quiz list creation
    String [][] questAnsw = new String[20][5];
    //Image list creation
    int [] questImgArray = new int[3];

    //Correct answers list
    int [] correctAns = new int[20];
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        //Audio questions
        questAnsw[10][0] = "Nombre de la siguiente canción"                     questAnsw[9][1] = "Lamento de Midna";                     questAnsw[9][2] = "Canción de curación";               questAnsw[9][3] = "Nana de Zelda";                   questAnsw[9][4] = "Canción del tiempo";
        ...
        questVideo = findViewById(R.id.vidQstn);
